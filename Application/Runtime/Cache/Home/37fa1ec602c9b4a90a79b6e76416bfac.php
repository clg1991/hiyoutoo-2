...
<?php $center_user_page=U('center/centershow',array('page_user_id'=>$_SESSION['userid'])) ?>
...
<nav class="navbar navbar-default" role="navigation"  id='navbar' >
   ...
   <div class="collapse navbar-collapse" id="example-navbar-collapse" >
      <ul class="nav navbar-nav" id='navul'>
       ...
       <li><div class="youtoo-layout-header" style="<?php echo ($centerheader); ?>"  onclick="window.location.href='<?php echo ($center_user_page); ?>'" ><?php echo $_SESSION['username']; ?>用户中心</div></li>
...
<div class='infoedit-input'>
<p  class='infoedit-input'>修改个人资料</p>
